...
class Item(
    ...
    TimeStamedModel: An abstract base class model that provides self-managed "created" and "modified" fields.

    ActivatorModel: An abstract base class model that provides activate and deactivate fields.
